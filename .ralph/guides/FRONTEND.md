...
| Hard-coded colors | Inconsistent, hard to maintain | Use CSS variables / css classes |
...
### Grid & Spacing
- Use consistent spacing scale (css: 2, 4, 6, 8, 12, 16, 24, 32)
...
- [ ] Using css classes or CSS variables
